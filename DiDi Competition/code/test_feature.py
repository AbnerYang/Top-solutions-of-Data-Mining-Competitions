...
for idx, date in enumerate([22,24,26,28,30]):
    print ('date {0:0>2}'.format(date))
    order = utils.get_orders(test_prefix + 'order_data/order_data_2016-01-{0:0>2}'.format(date))
    ...
    weather = utils.get_weather(test_prefix + 'weather_data/weather_data_2016-01-{0:0>2}'.format(date))
    ...
    traffic = utils.get_traffic(test_prefix + 'traffic_data/traffic_data_2016-01-{0:0>2}'.format(date))
